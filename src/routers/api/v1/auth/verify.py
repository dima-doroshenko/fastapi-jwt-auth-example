...
from utils import EmailAlreadyVerified, text
...
async def confirm_verification(
    verification_data: VerificationCodeSchema, user: get_current_user
) -> Answer:
    await user.email_actions.verify_code(
        verification_data.code, EmailConfirmationType.verify
    )
